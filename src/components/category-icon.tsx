 ...
 * sich aehnelnden Namen -- das Symbol macht eine Zeile auf einen Blick
 * unterscheidbar, lange bevor man den Text gelesen hat.
 *
 * Bewusst nur ueber den Kategorie-Key: Nutzer duerfen Kategorien frei
 * anlegen, und fuer einen selbst erdachten Key gibt es kein Symbol. Der
 * Fallback (Kiste) ist deshalb kein Ausnahmefall, sondern der Normalfall fuer
 * alles Selbstangelegte.
 */
