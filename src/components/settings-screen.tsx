 ...
 *
 * `recipesRow` hängt hinten an der Karte und kommt fertig gerendert vom
 * Server (app/settings/page.tsx): Ob die Zeile überhaupt erscheint, hängt an
 * GEMINI_API_KEY, und den kann diese Client-Komponente nicht lesen. Meistens
 * ist es null -- steht der Schlüssel, führt die Fußleiste selbst zu den
 * Rezepten.
 */
const ROWS: {
  href: string;
...
export function SettingsScreen({ recipesRow }: { recipesRow: ReactNode }) {
